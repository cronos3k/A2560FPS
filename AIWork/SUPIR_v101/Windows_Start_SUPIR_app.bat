...
REM python gradio_demo.py %lowvram% %tiledVAE% %theme% %cpuMove% --open_browser --outputs_folder_button --ckpt_dir "C:\temp\b" --lora_dir "C:\temp\c"
 
REM this above line shows you example custom SDXL models path (--ckpt_dir) and Lora path (--lora_dir)
